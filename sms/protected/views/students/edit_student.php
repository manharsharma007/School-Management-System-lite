				...
				<div class="row content">
					...
					<div class="form">
						<div class="form-header">
							<p><i class="fa fa-pencil"></i> Please fill the student details</p>
						</div>
	...
	?>						<input type="hidden" name="security_token" value = "<?= $token ?>"/>
								...
								<?php
									...
									foreach ($class as $key => $value) {
										if($class_id == $value->class_id) 
											...
											$cla = '';
										echo '<option  value="'.$value->class_id.'" '.$cla.'>'.$value->class_name.'</option>';
									}
								?>
								</select>
							</div>
							...
							<div class="input-element-half">
								...
								<input type="text" id="roll_no" name="roll_no" value="<?= isset($roll_no) ? $roll_no : '' ; ?>">
							</div>
							<div class="input-element-half">
							...
							<div class="input-element-half">
								...
								<select name="student_status" id="student_status">
									<option value="STUDYING" <?php if($student_status == 'STUDYING') echo 'selected' ?>>STUDYING</option>
									<option value="TRANSFERRED" <?php if($student_status == 'TRANSFERRED') echo 'selected' ?>>TRANSFERRED</option>
									<option value="LEFT" <?php if($student_status == 'LEFT') echo 'selected' ?>>LEFT</option>
								</select>
							</div>
							...
							<fieldset>
								...
								<div class="input-element-half">
									...
									<select name="fee_mode" id="fee_mode">
										<option value="ANNUALLY" <?php if($fee_mode == 'ANNUALLY') echo 'selected' ?>>ANNUALLY</option>
										<option value="MONTHLY" <?php if($fee_mode == 'MONTHLY') echo 'selected' ?>>MONTHLY</option>
									</select>
								</div>
								<div class="input-element-half">
									<label for="discount_percent">Discount Percent <sup>*</sup></label>
									<input type="text" id="discount_percent" name="discount_percent" value="<?php if(isset($discount_percent) && $discount_percent != '') echo $discount_percent; else echo '0' ?>">
								</div>
								</div>
							...
							<div class="col-2">
								<fieldset>
									...
									<div class="input-element">
										...
										<input type="checkbox" id="father_working" name="father_working" <?php if($father_working) echo 'checked'; ?>>
									</div>
									<div class="input-element">
							...
							<div class="col-2">
								<fieldset>
									...
									<div class="input-element">
										...
										<input type="checkbox" id="mother_working" name="mother_working" <?php if($mother_working) echo 'checked'; ?>>
									</div>
									<div class="input-element">
									...
									<div class="input-element-half">
										...
										<input type="text" id="mother_phone" name="mother_phone" value="<?php if(isset($mother_email)) echo $mother_email ?>">
									</div>
